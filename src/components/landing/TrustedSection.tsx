...
// Premium SVG logos for media outlets (using currentColor for easy hover effects)
const mediaLogos = [
  {
    name: "TechCrunch",
    svg: (
  ...
  return (
    <section className="py-16 bg-white border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <p className="text-center text-xs md:text-sm font-bold tracking-[0.2em] text-gray-400 uppercase mb-10">
