...
import type { CareerProfileEducationModalProps } from '../../../types/dashboard';

const CareerProfileEducationModal: React.FC<CareerProfileEducationModalProps> = ({
  open,
  value,
  onClose,
  onChange,
...
export default CareerProfileEducationModal;
